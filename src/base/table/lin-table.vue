<template>
  ...
  >
    <el-table-column type="selection" v-if="selection" width="40"></el-table-column>
    <el-table-column
...
export default {
  ...
  methods: {
    ...
    handleUpdateVisit(_this, index, row) {
      _this.$emit("handleUpdateVisit", { index, row });
    },
    handleUpdateReask(_this, index, row) {
      _this.$emit("handleUpdateReask", { index, row });
    },
